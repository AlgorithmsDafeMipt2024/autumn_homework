...
OrientedWeightedGraphWithZeroWeight::OrientedWeightedGraphWithZeroWeight(const WeightedGraph& graph)
{
...
bool OrientedWeightedGraphWithZeroWeight::AddEdge(int id0, int id1, double value)
{
	if (id0 == id1)
		return true;
