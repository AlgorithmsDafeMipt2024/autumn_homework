...
int main() {
  ...
  std::cout << "LCA(d, e): " << lca_str.RequestLCA("d", "e")
            << std::endl;  // LCA(d, e): b
  std::cout << "LCA(d, f): " << lca_str.RequestLCA("d", "f")
            << std::endl;  // LCA(d, f): a
  std::cout << "LCA(g, e): " << lca_str.RequestLCA("g", "e")
            << std::endl;  // LCA(g, e): a
  ...
  std::cout << "LCA(3, 4): " << lca_int.RequestLCA(3, 4)
            << std::endl;  // LCA(3, 4): 1
  std::cout << "LCA(3, 6): " << lca_int.RequestLCA(3, 6)
            << std::endl;  // LCA(3, 6): 0
  std::cout << "LCA(5, 6): " << lca_int.RequestLCA(5, 6)
            << std::endl;  // LCA(5, 6): 2
  ...
  std::cout << "LCA(3, 4): " << lca_undirected_graph.RequestLCA(3, 4)
            << std::endl;  // LCA(3, 4): 1
  std::cout << "LCA(3, 6): " << lca_undirected_graph.RequestLCA(3, 6)
            << std::endl;  // LCA(3, 6): 0
  std::cout << "LCA(5, 6): " << lca_undirected_graph.RequestLCA(5, 6)
            << std::endl;  // LCA(5, 6): 2
