#ifndef AUTUMN_HOMEWORK_TASK_05_LCA_TREE_TPP_
#define AUTUMN_HOMEWORK_TASK_05_LCA_TREE_TPP_
#include <cmath>
#include <cstddef>
#include <vector>
// то же самое, что в задаче 06
...
class LcaTree {
 public:
  size_t lca(size_t u, size_t v) { return vtx_[rmq_.rmq1(I_[u], I_[v]).i]; }
